...
def prob(ra_grid,dec_grid,ra,dec,err):                      # calculate the probability of specific grid (gaussian dist.)
...
def fermi_skymap(gbm_ra, gbm_dec, gbm_err):                         # calculate the probability for all skymap grids
